#!/bin/bash
# Fathom installer v0.2.4-Beta — IOReport package watts + sleep/wake drain events
set -Eeuo pipefail
IFS=$'\n\t'
umask 077
...
EXPECTED_HASH="d23e541d295c41ab94c3d0c8ee90b434a4aa8053d3765f9179bbe7416535c1de"
...
let FATHOM_VERSION = "v0.2.4-Beta"
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    if showFathomSettings {
                        VStack(alignment: .leading, spacing: 6) {
                            ...
                            Text("Hide the system Battery item in System Settings → Control Center so Fathom is your battery menu.")
                                .font(uiFont(11))
                                .foregroundColor(.labelTertiary)
                                .fixedSize(horizontal: false, vertical: true)
                        }
