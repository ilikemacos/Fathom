#!/bin/bash
# Fathom installer v0.2.5-Beta — IOReport package watts + sleep/wake drain events
set -Eeuo pipefail
IFS=$'\n\t'
umask 077
...
EXPECTED_HASH="4c8af4c07d9e64238ae8f9f959965bf52d126b303f17b90f50e23abe669507e2"
...
let FATHOM_VERSION = "v0.2.5-Beta"
